...
libnivel2();
require_once '../controller/encuestaModificar.php';
?>
<html lang="es">
    <head>
        <meta charset="utf-8">
                ...
                <div id="wrapper">
                    ...
                    <div class="wrapper" align="center">
                        ...
                        if ($_GET) {
                            if ($_GET['id']) {
                                $id = $_GET['id'];
                                $row = obtenerEncuesta($id);
                            }
                        }
                        ?>
                        <div class="wrapper">
                            <form method="POST" class="form-signin" action="../controller/encuestasModificar2.php?id=<?php echo $row['idEncuesta']; ?>"  >
                                ...
                                <h2 class="form-signin-heading">Modificar Encuesta</h2>
                                <br>
                                <div><span><i></i></span>
                                    <input type="text"  class="form-control" id="inputmodificarEncuesta" name="titulo" placeholder="Encuesta" autofocus value="<?php echo $row['titulo']; ?>"/></div>
                                <br>
                                <input type="date"  class="form-control" id="inputmodificarFecha" name="fecha" placeholder="Fecha" autofocus value="<?php echo $row['fecha']; ?>"/>
                                <br>  
                                <br>
                                <br>
                                <div align="center">
                                    <button class="btn btn-lg btn-success btn-group-lg" type="submit">Modificar Encuesta</button>
                                </div>
                            </form>
