    ...
    <body class="background">
        <div class="col-md-6 col-lg-6 col-sm-8 col-xs-11 navbar-fixed-bottom rcorners text-center" style="margin-bottom: 5%;margin-left:10px;margin-right:10px;margin-top: 10%">
            <div id="pregunta1" name="pregunta1">
                ...
                $sql = "SELECT * FROM preguntas INNER JOIN respuesta ON preguntas.id_pregunta=respuesta.id_pregunta WHERE preguntas.id_pregunta='115'";
                ...
                <h2><input type="number" id="respuesta_edad" name="respuesta_edad"></h2>
                <input type="submit" name="btnaceptar" value="Aceptar">
                <a href="../view/encuestasContestar3.php" class="volver">&larr; Volver</a>
