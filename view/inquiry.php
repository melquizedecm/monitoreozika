                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                         ...
                                         <form action="../controller/encuestas.php" method="POST">
                                        <div class="modal-body">
                                           
                                                <div class="form-group">
                                                    <label for="encuestaNombre"> Nombre de la encuesta: </label><br>
                                                    <input id="inputTitulo" type="text" class="form-control"  name="inputTitulo" placeholder="Escribe aquí el titulo" autofocus/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="encuestaFecha"> Fecha: </label><br>
                                                    <input class="form-control" id="inputFecha" type="date" name="inputFecha">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button id="botonGenerarCaso"  class="btn btn-primary" type="submit">Generar Encuesta</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $tabla->fetch_array(MYSQLI_BOTH)) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a role="button" class="btn btn-primary" href="encuestaModificar.php?id=<?php echo $row['idEncuesta']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> </td>
                                                <td align="center" ><a role="button"  class="btn btn-danger"  href="../controller/encuestaEliminar.php?id=<?php echo $row['idEncuesta']; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a> </td>
