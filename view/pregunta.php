                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <a class="btn btn-primary" href="preguntas_respuestas.php">Generar</a>
                                ...
                                <table  id="tabla"class="table table-bordered table-striped"  >
                                    <thead alimhg="center">
                                        <tr>
                                            <th>ID Pregunta</th>
                                            <th>Pregunta</th>
                                            <th align="center">Operacion Modificar</th>
                                            <th align="center">Operacion Eliminar</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        while ($row = $tabla->fetch_array(MYSQLI_BOTH)) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                   <a role="button"  class="btn btn-primary" href="preguntasModificar.php?id=<?php echo $row['id_pregunta']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> </td>
                                                <td align="center"> <a class="btn btn-danger" role="button" href="../controller/preguntaEliminar.php?id=<?php echo $row['id_pregunta']; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
